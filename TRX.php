...
system("clear");
echo "\033[1;92m";
system("toilet -f wideterm -F border ' SCRIPT MINING CRYPTO TRX COIN '");
...
echo " \033[1;91m[\033[1;92m3\033[1;91m] \033[1;97mLogin Server \033[1;91mTRON MINER\n";
echo " \033[1;97mSelect Your Chose \033[1;90m: \033[1;91m";
...
//$wallet = current($wal);
while("true"){
echo " \033[1;97mWallet TRX  \033[1;90m: \033[1;91m";
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL,
"https://trx.coinsx.site/ajax_auth");
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_POST, 1);
curl_setopt($ch, CURLOPT_HTTPHEADER, $ua);
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
$data = "username=".$wallet."&password=reki240210&reference_user_id=83428";
curl_setopt($ch, CURLOPT_POSTFIELDS, $data);
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL,
"https://trx.coinsx.site/dashboard");
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
//curl_setopt($ch, CURLOPT_POST, 1);
curl_setopt($ch, CURLOPT_HTTPHEADER, $ua);
...
$a = explode('"',$a1[1]);
echo " \033[1;97mYour Balance \033[1;91m[\033[1;92m".$a[0]."\033[1;91m] \033[1;95mTRX                                \r";
//if ($a[0]==""){
//echo "\033[1;91m";
//system("toilet -f wideterm -F border '        LOST   CONNECTION       '"); 
//echo " \033[1;91mLOST CONNECTION\n";
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL,
"https://trx.coinsx.site/withdrawal");
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_POST, 1);
curl_setopt($ch, CURLOPT_HTTPHEADER, $ua);
...
$d1 = explode('id="toastr-success-top-right">',$result);
$d = explode(' <',$d1[1]);
...
//exit;
//}
if ($d[0]=="Confirm Withdrawal"){
$e1 = explode('<input value="',$result);
$e = explode('"',$e1[1]);
echo "\033[1;92m";
system("toilet -f wideterm -F border '    SUCCESS   $a[0] TRX    '");
